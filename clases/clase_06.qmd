...
Se pueden crear cerca de 6 intervalos
- Valor máximo
```{r}
...
Se denota con la letra griega sigma (σ).
La desviación estándar ($\sigma$) mide la dispersión de los datos respecto a la media poblacional.
